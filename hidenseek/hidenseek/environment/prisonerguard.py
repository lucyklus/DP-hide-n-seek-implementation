# The entirety of environment logic
import functools
import random
...
class env(ParallelEnv):
    ...
    def step(self, actions):
        ...
        # Generate action masks - possible movements (up, down, left, right)
    ...
    def render(self):
        ...
        grid = np.zeros((7, 7), dtype=np.str_)
